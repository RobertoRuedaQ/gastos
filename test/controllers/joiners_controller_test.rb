...
class JoinersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joiner" do
    assert_difference('Joiner.count') do
      post joiners_url, params: { joiner: { category: @joiner.category, expense: @joiner.expense, type: @joiner.type } }
    end
  ...
  test "should update joiner" do
    patch joiner_url(@joiner), params: { joiner: { category: @joiner.category, expense: @joiner.expense, type: @joiner.type } }
