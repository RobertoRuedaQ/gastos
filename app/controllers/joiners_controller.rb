class JoinersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @joiner.save
        format.html { redirect_to @joiner, notice: 'Joiner was successfully created.' }
        format.json { render :show, status: :created, location: @joiner }
      else
  ...
  private
    ...
    def joiner_params
      params.require(:joiner).permit(:expense, :category, :type)
    end
end
